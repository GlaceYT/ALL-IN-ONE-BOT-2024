...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('beautiful')
        .setDescription('Apply a beautiful effect to a user\'s profile picture.')
            ...
            if (interaction.isCommand && interaction.isCommand()) { 
                ...
                try {
                    ...
                    const embed = new EmbedBuilder()
                        .setTitle('Beautiful Effect')
                        .setDescription(`Here's a beautiful version of ${user}'s profile picture!`)
                        .setImage('attachment://beautiful-image.png') 
                        .setColor('#FF69B4')
                        .setFooter({ text: `Beauty is in the eye of the beholder! ✨` });

                    await interaction.editReply({ 
                        content: `Here's how ${user} looks with a touch of beauty!`, 
                        embeds: [embed], 
