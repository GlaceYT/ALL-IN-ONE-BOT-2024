...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(`Click [here](https://discord.com/oauth2/authorize?client_id=${clientId}&permissions=${adminPermissions}) to invite the bot to your server with administrator permissions.`)
            .setTimestamp();
